...
MATERIALS = {
    ...
    "Poster": {
        "url": "https://github.com/CyberAgentAILab/AdTEC/blob/main/materials/NAACL2025-poster.pdf",
        "icon": "camera",
        "is_external": True,
    },
    "Slides": {
        "url": "https://github.com/CyberAgentAILab/AdTEC/blob/main/materials/NAACL2025-slides.pdf",
        "icon": "images",
        "is_external": True,
    },
    "Video": {
        "url": "https://youtu.be/3QmKidnlkiI",
        "icon": "video",
        "is_external": True,
    },
}
